...
export class Area {
  ...
  public constructor(designation?: string,
    ...
    this.locations = [
      ...
      new Location('223', false, 'B', 40, 23, 5),
      new Location('065', true, 'A', 89, 23, 6),
      new Location('005', true, 'B', 67, 78, 7),
      new Location('102', false, 'A', 54, 64, 8),
      new Location('252', false, 'B', 23, 45, 9),
    ];
  }
}
